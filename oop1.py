class Employee:
   ...
   def __init__(self, name, salary): #    The first method __init__() is a special method, which is called class constructor or
...
emp1 = Employee(str(raw_input("What's the name of the first employee? :")), int(raw_input("What about his salary? :")))
"This would create second object of Employee class"
emp2 = Employee(str(raw_input("What's the name of the second employee? :")), int(raw_input("What about his salary? :")))
